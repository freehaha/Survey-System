...
$schema->add_topic({
	...
	creator => 1,
	begin_date => timelocal(0,0,0,29,6,2010),
...
$schema->add_topic({
	...
	questions => [
		likert_choice(1, 'q2', options qw/option1 option2/),
		likert_choice(2, 'q2', options qw/option1 option2/),
		likert_choice(3, 'q3', options qw/option1 option2/),
		likert_choice(4, 'q4', options qw/option1 option2/),
		likert_choice(5, 'q5', options qw/option1 option2/),
		open_question(6, 'q6'),
		open_question(7, 'q7'),
		open_question(8, 'q8'),
		open_question(9, 'q9'),
